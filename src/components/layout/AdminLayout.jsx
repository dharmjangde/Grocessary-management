...
export default function AdminLayout({ children, darkMode, toggleDarkMode }) {
  ...
  const routes = [
    ...
    // {
    //   href: "/dashboard/Crockery",
    //   label: "Crockery",
    //   icon: Coffee,
    //   active: location.pathname === "/dashboard/Crockery",
    //   showFor: ["admin", "user"]
    // },
    // {
    ...
    //   label: "Disposal",
    //   icon: Trash2,
    //   active: location.pathname === "/dashboard/Disposal",
    //   showFor: ["admin", "user"]
    // },
    // {
    ...
    //   label: "Decor",
    //   icon: HomeIcon,
    //   active: location.pathname === "/dashboard/Decor",
    //   showFor: ["admin", "user"]
    // },
    // {
    ...
    //   label: "Dresses",
    //   icon: Shirt,
    //   active: location.pathname === "/dashboard/Dresses",
    //   showFor: ["admin", "user"]
    // },
    // {
    ...
    //   label: "Grocery",
    //   icon: ShoppingBasket,
    //   active: location.pathname === "/dashboard/Grocery",
    //   showFor: ["admin", "user"]
    // },
    // {
    ...
    // active: location.pathname === "/dashboard/Filter",
    // showFor: ["admin", "user"]
    //  },
    {
    ...
    <div className={`flex h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50`}>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-14 items-center justify-between border-b border-blue-200 bg-white px-4 md:px-6">
          ...
          <h1 className="text-lg font-semibold text-blue-700">Grocery IMS</h1>
